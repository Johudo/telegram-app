...
const TOKEN = "6530914796:AAFjaLc-vuUd-FiXhUoftbQ53UoTgiqMhmQ";
const WEB_APP_URL = "https://habr.com/ru/articles/666278/";
...
//Build keyboards
const firstMenuMarkup = new InlineKeyboard().text(nextButton, backButton).webApp("WebApp", WEB_APP_URL);
